 ...
 */
lobby.Sha1.prototype.reset = function() {
 ...
 * @private
 */
lobby.Sha1.prototype.rotl_ = function(w, r) {
 ...
 * @private
 */
lobby.Sha1.prototype.compress_ = function(buf) {
  var W = this.W_;
 ...
 */
lobby.Sha1.prototype.update = function(bytes, opt_length) {
  if (!opt_length) {
 ...
 */
lobby.Sha1.prototype.digest = function() {
  var digest = [];
